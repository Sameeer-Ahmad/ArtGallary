  ...
  return (
    <Box bg="brand.100">
      ...
      <Text pl={8} pb={4} color="gray.600" maxW="600px">
        Photography from pioneering 19th-century masters to modern
        photographers, priced in ₹ and delivered to your door.
      </Text>
        ...
        <>
          ...
          {!hasMore && arts.length > PAGE_SIZE && (
            <Text textAlign="center" py={8} color="gray.500">
              You&apos;ve reached the end — {arts.length} photographs
            </Text>
          )}
        </>
      )}
