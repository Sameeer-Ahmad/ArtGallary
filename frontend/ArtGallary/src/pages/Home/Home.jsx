...
const Home = () => {
  ...
  return (
    <Box display={"flex"} flexDir={"column"} alignItems={"center"} padding={4} bg="rgb(250,248,244)">
      <Text w={"80%"} alignSelf={"flex-start"} pl={7} fontSize={["40px", "60px", "80px"]} font fontFamily={"Addington CF"} >Transforming spaces <Text> with art and design</Text></Text>
      ...
      <Box display={"flex"} width={"70%"} flexWrap={"wrap"} gap={"15px"} marginTop={"30px"}>
        ...
        <Flex  gap={8} direction={{ base: "column", sm: "row" }} justifyContent="space-between">
          {boxes.map((box, index) => (
            <Box
      ...
      <Box display={"flex"} flexDir={"column"} gap={"15px"} mt={12} textAlign={"center"} width={"95%"} alignItems={"center"}  >
        ...
        <Box display={["column", "flex"]} width={"100%"} justifyContent={"space-between"} mt={5} mb={12} textAlign={"center"} gap={"5px"} >
          <Box> <Image cursor={"pointer"} src='https://ik.imagekit.io/theartling/prod/tr:w-520,h-520,bg-FFFFFF/dynamic_images/Image/ad497378b24f4087995bea9d4e9719d4.JPG' />
            <Text mt={4} mb={12} fontSize={"20px"}>Design Objects</Text></Box>
          <Box> <Image cursor={"pointer"} src='https://ik.imagekit.io/theartling/prod/tr:w-520,h-520,bg-FFFFFF/dynamic_images/Image/75e6ad5d1c0840168c39f32d67a7d249.jpg' />
            <Text mt={4} mb={12} fontSize={"20px"}>Furniture</Text></Box>
          <Box> <Image cursor={"pointer"} src='https://ik.imagekit.io/theartling/prod/tr:w-520,h-520,bg-FFFFFF/dynamic_images/Image/a5cd9baac7624f15b695a1937b674f78.jpg' />
            <Text mt={4} mb={12} fontSize={"20px"}>Lighting</Text></Box>
          <Box> <Image cursor={"pointer"} src='https://ik.imagekit.io/theartling/prod/tr:w-520,h-520,bg-FFFFFF/dynamic_images/Image/7d3648d9a83f4bebbb5906d2ee60a34b.jpg' />
      ...
      >
        ...
        <Box display={"flex"} flexDir={["column", "row"]} gap={"15px"} mt={5} textAlign={"left"} >
          <Box> <Image cursor={"pointer"} src='https://ik.imagekit.io/theartling/prod/tr:w-998,h-760,bg-FFFFFF/original_images/biennale-arte-24-banner2.jpg' />
          ...
          <Box> <Image cursor={"pointer"} src='https://ik.imagekit.io/theartling/prod/tr:w-998,h-760,bg-FFFFFF/original_images/Image_courtesy_of_Tatler_Asia.webp' />
          ...
          <Box> <Image cursor={"pointer"} src='https://ik.imagekit.io/theartling/prod/tr:w-998,h-760,bg-FFFFFF/original_images/image_courtesy_of_mega_furniture.jpeg' />
